...
def analysis_part(df_r):
    ...
    #
    # ans = cm.main_cross_move_analysis_and_order({"df_r": df_r})
    # print(ans)
...
gl_target_time = datetime.datetime(2024, 11, 19, 6, 20, 6)  # 検証時間 (以後ループの有無で調整） 6秒があるため、00:00:06の場合、00:05:00までの足が取れる
# ■■方法の指定
