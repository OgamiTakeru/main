...
def analysis_part(df_r):
    ...
    # ans = ri.judge_strength_from_predict_line_based_all_same_price_list({"df_r": df_r})
    # print(ans)
...
gl_target_time = datetime.datetime(2024, 10, 15, 12, 50, 6)  # 検証時間 (以後ループの有無で調整） 6秒があるため、00:00:06の場合、00:05:00までの足が取れる
# ■■方法の指定
